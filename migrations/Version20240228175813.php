 ...
 */
final class Version20240228175813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quiz (id INT NOT NULL, details TEXT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quiz_result (id INT NOT NULL, details TEXT NOT NULL, PRIMARY KEY(id))');
